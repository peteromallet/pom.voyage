...
export const HOME_CARDS: HomeCardData[] = [
  ...
  {
    id: 'second-renaissance-plan',
    kind: 'story',
    title: 'A plan to accelerate the 2nd Renaissance',
    position: 6,
    category: 'initiatives',
    cardClassName: 'card story-tile loading-element',
    imageSrc: asset('renaissance-plan-visual.png'),
    imageAlt: 'Renaissance plan visual',
    paragraphs: [
    ...
    linkLabel: 'Understand the plan',
    linkHref: 'https://banodoco.ai/',
  },
  {
    id: 'irish-pub-family',
    kind: 'story',
